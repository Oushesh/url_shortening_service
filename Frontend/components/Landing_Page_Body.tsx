...
export default function LandingPageBody() {
  ...
  const handleFormSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const url = new URL('https://url-shortening-service-backend-fastapi-local.vercel.app/encode_url');
  ...
  const handleLongFormSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const url = new URL('https://url-shortening-service-backend-fastapi-local.vercel.app/decode_url');
