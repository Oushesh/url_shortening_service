...
export default function LandingPageBody() 
{
  ...
  <div className="flex flex-col space-y-5">
    ...
    <a href="https://calendly.com/oushesh/30min" target="_blank" rel="noopener noreferrer">
      <div className="justify-center flex text-xl w-full px-4 py-2
                    text-zinc-200 bg-zinc-900 border-[1px]
                    border-zinc-700 focus:bg-slate-200
                    rounded-tl-full rounded-bl-full rounded-br-full
                    rounded-tr-full focus:outline-none
                    focus:ring-[1px] focus:ring-sky-500
